# apt install wget
# rm clone_emmc.sh
# wget -O clone_emmc.sh https://github.com/btngh/AntBmsToCan/raw/refs/heads/master/AntBmsToCan/boot.sh?v=$(date +%s)
# chmod +x boot.sh
# ./boot.sh
...
gunzip -f BPI-R2-EMMC-boot0-DDR1600-0k-0905.img.gz
dd if=BPI-R2-EMMC-boot0-DDR1600-0k-0905.img of=/dev/mmcblk1boot0 bs=1k conv=sync,notrunc
gunzip -c u-boot-2019.07-bpi-r2-2k.img.gz | dd of=/dev/mmcblk1boot0 bs=1024 seek=2 status=progress
rm -f BPI-R2-EMMC-boot0-DDR1600-0k-0905.img
